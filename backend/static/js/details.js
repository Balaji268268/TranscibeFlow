...
function initializeAudioPlayer(item) {
    ...
    // History stores confidence as decimal (0.0-1.0), convert to percentage
...
// PDF Export handler for details page
function triggerDetailsPDFExport() {
    ...
    exportToPDF({
        ...
        // Confidence is stored as decimal in history, convert to %
        confidence: item.confidence_score ? Math.round(item.confidence_score * 100) : null,
